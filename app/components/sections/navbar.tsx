                                ...
                                <NavigationMenuContent>
                                    <ul className="grid w-[200px] gap-4 p-4">
                                        <ListItem href="#" title="Backlog">
                                            <CircleHelpIcon className="inline-block mr-2 h-4 w-4" />
                                            Task needs review
                                        </ListItem>
                                        <ListItem href="#" title="To Do">
                                            <CircleIcon className="inline-block mr-2 h-4 w-4" />
                                            Task in progress
                                        </ListItem>
                                        <ListItem href="#" title="Done">
                                            <CircleCheckIcon className="inline-block mr-2 h-4 w-4" />
                                            Task completed
                                        </ListItem>
                                    </ul>
                                </NavigationMenuContent>
